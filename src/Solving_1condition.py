...
def FLUX_2puits (C_0, Ci_m, longueur_commune_entrenoeuds, rayon_commun_entrenoeuds) :
    ...
    print("AAAAAAAAAAAAAAAAAAAAAAAAA", Ci_m)
    ...
    return eq
print("Valeurs flux : ", FLUX_2puits (BASE_C_0, conditions_ini_C1C2, BASE_longueur_commune_entrenoeuds, BASE_rayon_commun_entrenoeuds))
...
def A_RESOUDRE (Ci_m, C_0, longueur_commune_entrenoeuds, rayon_commun_entrenoeuds, coef_delta_feuilles, coef_delta_bourgeon, volume_fixe_feuilles, volume_fixe_bourgeon, valeurs_RER_bourgeon, valeurs_RER_feuilles) :
    ...
    C1_m = FLUX_2puits (C_0, Ci_m, longueur_commune_entrenoeuds, rayon_commun_entrenoeuds)[0] - UTILISATION (coef_delta_feuilles, coef_delta_bourgeon, volume_fixe_feuilles, volume_fixe_bourgeon, valeurs_RER_bourgeon, valeurs_RER_feuilles)[0]
    C2_m = FLUX_2puits (C_0, Ci_m, longueur_commune_entrenoeuds, rayon_commun_entrenoeuds)[1] - UTILISATION (coef_delta_feuilles, coef_delta_bourgeon, volume_fixe_feuilles, volume_fixe_bourgeon, valeurs_RER_bourgeon, valeurs_RER_feuilles)[1]
...
for condition in range(1) : 
    ...
    print("Solutions C1_m et C2_m pour la condition ",nom_condition[condition], Ci_m)
